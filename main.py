...
#Konfiguracja serwera
  server = tf.train.Server(ClusterSpecification.CLUSTER_SPEC, job_name='worker', task_index=0)
  ...
  with tf.train.MonitoredTrainingSession(master=server.target, is_chief=True) as sess:
